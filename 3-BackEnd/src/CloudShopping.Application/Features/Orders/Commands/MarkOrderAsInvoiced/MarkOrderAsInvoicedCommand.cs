...
{
    public sealed record MarkOrderAsInvoicedCommand(int OrderId) : IRequest<Result>;
    ...
    public sealed class MarkOrderAsInvoicedCommandHandler : IRequestHandler<MarkOrderAsInvoicedCommand, Result>
    {
        ...
        public MarkOrderAsInvoicedCommandHandler(IOrderRepository orderRepository, IUnitOfWork unitOfWork)
        {
