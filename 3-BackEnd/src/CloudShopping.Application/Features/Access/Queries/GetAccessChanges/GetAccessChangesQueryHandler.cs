...
public sealed class GetAccessChangesQueryHandler(IAccessRepository repository) : IRequestHandler<GetAccessChangesQuery, IReadOnlyList<AccessChangeView>>
{
    public async Task<IReadOnlyList<AccessChangeView>> Handle(GetAccessChangesQuery request, CancellationToken ct)
    {
