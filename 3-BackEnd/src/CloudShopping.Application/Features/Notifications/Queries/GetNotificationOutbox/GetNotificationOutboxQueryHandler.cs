...
public sealed class GetNotificationOutboxQueryHandler(INotificationRepository repository) : IRequestHandler<GetNotificationOutboxQuery,IReadOnlyList<OutboxView>>
{
    public async Task<IReadOnlyList<OutboxView>> Handle(GetNotificationOutboxQuery request,CancellationToken ct)
    {
