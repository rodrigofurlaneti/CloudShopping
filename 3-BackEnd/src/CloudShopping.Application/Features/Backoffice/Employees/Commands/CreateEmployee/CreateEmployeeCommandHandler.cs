...
namespace CloudShopping.Application.Features.Backoffice.Employees.Commands.CreateEmployee
{
    public sealed class CreateEmployeeCommandHandler : IRequestHandler<CreateEmployeeCommand, Result<int>>
    {
        ...
        public async Task<Result<int>> Handle(CreateEmployeeCommand request, CancellationToken cancellationToken)
        {
            ...
            {
                // Adicionado o <int> para corresponder ao Result<int> esperado pelo MediatR
                return Result<int>.Failure(new Error("Employee.NotValidCpf", "Já existe um funcionário cadastrado com este CPF para esta empresa."));
            }
