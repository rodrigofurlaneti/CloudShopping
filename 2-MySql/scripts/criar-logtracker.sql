-- Execute na conexão correta do ecommerce. Não importa dados do dump.
USE ecommercedb;

-- Se a tabela já existe, este script não altera sua estrutura.
...
-- Sem FK para appuser: essa tabela pertence ao modelo de outro sistema.
-- Logs precisam sobreviver à exclusão de usuários e registrar falhas sem usuário autenticado.
SHOW CREATE TABLE logtracker;
